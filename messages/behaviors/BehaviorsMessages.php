...
class BehaviorsMessages extends Model
{
    ...
    const STAT_STATUS_OWNER_NOT_INSTANCEOF_DOCUMENT = 'You can attach StatusesBehavior only to instances of docflow\models\Document';
    const STAT_STATUS_OWNER_NOT_ONE_OF_CHILD_ROOT_STATUS = 'Текущий статус не принадлежит корневому статусу';
    const STAT_STATUS_OWNER_IS_EMPTY = 'Идектификатор статуса не определен';
